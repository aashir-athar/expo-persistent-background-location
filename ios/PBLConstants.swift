...
/// of the public JS contract (see `ExpoPersistentBackgroundLocation.types.ts`) —
/// do not rename without updating TypeScript in lock-step.
enum PBLConstants {
  static let moduleName = "ExpoPersistentBackgroundLocation"
  ...
  static let logTag = "[ExpoBgLocation]"
}
