 ...
 * `src/ExpoPersistentBackgroundLocation.types.ts`. Do not rename without
 * updating the TypeScript side in lock-step.
 */
internal object Constants {
  const val MODULE_NAME = "ExpoPersistentBackgroundLocation"
  const val TAG = "ExpoBgLocation"

  // ── Events (must match ExpoPersistentBackgroundLocationEvents) ────────────
  ...
  const val ACTION_START = "expo.modules.persistentbackgroundlocation.action.START"
  const val ACTION_STOP = "expo.modules.persistentbackgroundlocation.action.STOP"
  const val ACTION_RESTART = "expo.modules.persistentbackgroundlocation.action.RESTART"

  // ── SharedPreferences ─────────────────────────────────────────────────────
  const val PREFS_NAME = "expo_persistent_background_location"
