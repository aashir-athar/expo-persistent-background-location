/**
 * Example consumer for `expo-persistent-background-location`.
 *
 * A minimal run-tracker: request permission, start background tracking, watch
 * fixes stream in live (including after the app is backgrounded / swiped), and
 * inspect the offline buffer.
 *
 * Run:
 *   cd example
